...
(function () {
  ...
  // ---- Lessons 10-30: structured stubs (titles/arcs/questions real; steps to be authored) ----
  const stubs = [
    ['chapter-10', 10, ARCS.conversation, 'Better follow-ups', 'How do I steer a conversation instead of restarting it?'],
    ['chapter-11', 11, ARCS.conversation, 'Roles, formats & constraints', 'How do roles and formats change what I get back?'],
    ['chapter-12', 12, ARCS.conversation, 'Getting AI to teach you', 'How do I make AI a tutor, not an answer vending machine?'],
    ['chapter-13', 13, ARCS.judgment, 'Human agency', 'Where must a human stay in the loop?'],
    ['chapter-14', 14, ARCS.judgment, 'Verification & sources', 'How do I check a claim without trusting the AI’s word?'],
    ['chapter-15', 15, ARCS.judgment, 'Bias, fairness & perspective', 'How do I spot bias in an AI answer?'],
    ['chapter-16', 16, ARCS.judgment, 'Privacy & personal data', 'What should I never paste into an AI tool?'],
    ['chapter-17', 17, ARCS.judgment, 'When not to use AI', 'When is the right move to NOT use AI?'],
  ...
  window.LESSONS = authored.concat(arc2, stubs.map(lesson => lesson.id === 'chapter-25' ? chapter25 : lesson));
})();
