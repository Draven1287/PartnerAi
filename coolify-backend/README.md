...
ADMIN_CORS_ORIGINS=https://learningai4you.com,https://www.learningai4you.com,https://api.learningai4you.com
BUILD_SHA=local
BUILD_TIME=unknown

INCLUDE_LEGACY_MINUTES_JSON=false
IMPORT_LEGACY_JSON_STORE=false
...
- Leave `IMPORT_LEGACY_JSON_STORE=false` in production unless you are intentionally running a one-time legacy migration.
