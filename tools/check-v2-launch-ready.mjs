...
const gatedKinds = new Set(['classify', 'promptRepair', 'biasSpot', 'agentDesign', 'workflowChain']);
...
function checkBackendSurface() {
  ...
  if (index.includes('noindex, nofollow')) pass('v2-hidden-noindex');
  else fail('v2-hidden-noindex', 'V2 should remain noindexed before launch');
